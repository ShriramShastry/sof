...
int32_t sin_fixed(int32_t th_rad_fxp)
{
	...
	const int32_t CORDICSINE_PIOVERTWO_Q28FL	= Q_CONVERT_FLOAT(M_PI_2, 28);
	/* 843314857,  deg = 90.000000  */
	const int32_t CORDICSINE_PIOVERTWO_Q29FL	= Q_CONVERT_FLOAT(M_PI_2, 29);
	/* 1686629713, deg = 90.000000  */
	const int32_t CORDICSINE_PIOVERTWO_Q30FL	= Q_CONVERT_FLOAT(M_PI_2, 30);
