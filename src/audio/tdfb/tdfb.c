 ...
 */
#define CTRL_INDEX_ONOFF		0
#define CTRL_INDEX_DIRECTION		1
			  ...
			  int sink_nch)
{
	...
	/* In SOF v1.6 - 1.7 based beamformer topologies the multiple angles, mic locations,
